...
def __make_file_target(file: h5py.File, open_kwargs) -> Optional[FileTarget]:
...
def __find_datasets_under_group(group, header, open_kwargs):
    known_datasets = []
